...
-With the same files and password, you can also add to the existing database directory contents and data will be appended.Existing directory structures will also be expanded if new items exist as same directory structures. It is much faster than rar because we don't decrypt the whole database all over again
