...
-After you encrypted your data, use the salt and password to decrypt the file structure. Selecting files or directories on the tree list will extract them on the designated folder
